...
(function() {
    ...
    class FrontController {
        constructor(config = {}) {
            ...
            // Use config from window.APP_CONFIG if available, otherwise fallback
            this.apiBaseUrl = config.apiBaseUrl || 
                             (window.APP_CONFIG && window.APP_CONFIG.apiBaseUrl) || 
                             'http://localhost:5000/api';
            
            this.log('info', 'FrontController initialized', { apiBaseUrl: this.apiBaseUrl });
        ...
        handleRouteChange() {
            ...
            this.log('info', `Handling route change: ${path}`);
        ...
        async apiCall(endpoint, options = {}) {
            try {
                this.log('info', `API Call: ${endpoint}`);
                ...
                <div class="card">
                    <div class="chat-container">
                        ...
                        <div class="chat-input-form">
                            <input type="text" id="messageInput" placeholder="Type your message..." autocomplete="off" spellcheck="false" autocorrect="off" autocapitalize="off">
